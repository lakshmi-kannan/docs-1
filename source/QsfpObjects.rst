...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		swtch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = swtch.updateQsfp(QsfpId=qsfpid, PMClassBAdminState=pmclassbadminstate, HigherAlarmTemperature=higheralarmtemperature, HigherWarningVoltage=higherwarningvoltage, LowerAlarmTemperature=loweralarmtemperature, LowerAlarmVoltage=loweralarmvoltage, LowerWarningTemperature=lowerwarningtemperature, LowerWarningVoltage=lowerwarningvoltage, PMClassAAdminState=pmclassaadminstate, PMClassCAdminState=pmclasscadminstate, AdminState=adminstate, HigherAlarmVoltage=higheralarmvoltage, HigherWarningTemperature=higherwarningtemperature)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		swtch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = swtch.updateQsfpById(ObjectId=objectidPMClassBAdminState=pmclassbadminstate, HigherAlarmTemperature=higheralarmtemperature, HigherWarningVoltage=higherwarningvoltage, LowerAlarmTemperature=loweralarmtemperature, LowerAlarmVoltage=loweralarmvoltage, LowerWarningTemperature=lowerwarningtemperature, LowerWarningVoltage=lowerwarningvoltage, PMClassAAdminState=pmclassaadminstate, PMClassCAdminState=pmclasscadminstate, AdminState=adminstate, HigherAlarmVoltage=higheralarmvoltage, HigherWarningTemperature=higherwarningtemperature)
