...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		swtch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = swtch.createSubIPv4Intf(IntfRef=intfref, IpAddr=ipaddr, MacAddr=macaddr, Type=type, Enable=enable)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		swtch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = swtch.updateSubIPv4Intf(IntfRef=intfref, IpAddr=ipaddr, MacAddr=macaddr, Type=type, Enable=enable)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		swtch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = swtch.updateSubIPv4IntfById(ObjectId=objectidMacAddr=macaddr, Type=type, Enable=enable)
